...
For instance, for *regenie*-step1, as many jobs as phenotype will be created, versus  one job for each phenotype and chromosome for *regenie*-step2 and *PLINK 2.0*.
